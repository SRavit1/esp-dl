...
#define C4PD 0
#define C4PL 1 
static pckDtype l4wght[] = _97 ;
#define F5I  64
#define F5NPI  0
#define F5O  128
static pckDtype l5wght[] = _99 ;
static pckDtype l5act_bin[F5I/pckWdt]; 
#define F6I  128
#define F6NPI  0
#define F6O  2
static pckDtype l6wght[] = _100 ;
static pckDtype l6act_bin[F5O/pckWdt]; 
#define F7I  128
#define F7NPI  0
#define F7O  4
static pckDtype l7wght[] = _101 ;
static pckDtype l7act_bin[F6O/pckWdt]; 
#define F8I  128
#define F8NPI  0
#define F8O  10
static pckDtype l8wght[] = _102 ;
...
/*int main(){ 
	...
	for(int img = 0; img < 1; img++) {
		...
		FcXnorWrap(l6act_bin, l6wght, F6I, F6O, l7act_bin, bn2thr, bn2sign, bn2offset);
		FcXnorWrap(l7act_bin, l7wght, F7I, F7O, l8act_bin, bn3thr, bn3sign, bn3offset);
		int res = FcXnorNoBinWrap(l8act_bin, l8wght, F8I, F8O, output, bn4mean, bn4var, bn4gamma, bn4beta);
		float max = -INFINITY; 
		int maxIdx = 0; 
		for (int i = 0; i <10; i++) { 
			 printf("%f, ", output[i]);
