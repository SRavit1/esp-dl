...
#define C2PL 2
#define C2NPI 28
static uint8_t l2ind[] = _96_indices ;
static pckDtype l2wght[] = _96 ;
#define C3KXY 3
...
#define C3PL 2
#define C3NPI 28
static uint8_t l3ind[] = _99_indices ;
static pckDtype l3wght[] = _99 ;
#define F4I  64
#define F4NPI  6
#define F4O  128
static pckDtype l4wght[] = _101 ;
static uint8_t l4ind[] = _101_indices ;
static pckDtype l4act_bin[F4I/pckWdt]; 
#define F5I  128
#define F5NPI  0
#define F5O  2
static pckDtype l5wght[] = _102 ;
static uint8_t l5ind[] = _102_indices ;
static pckDtype l5act_bin[F4O/pckWdt]; 
#define F6I  128
#define F6NPI  8
#define F6O  4
static pckDtype l6wght[] = _103 ;
static uint8_t l6ind[] = _103_indices ;
...
/*int main(){ 
	...
	for(int img = 0; img < 1; img++) {
		...
		Fc3pxnWrap(l5act_bin, l5wght, l5ind, F5NPI, F5O, l6act_bin, bn2thr, bn2sign, bn2offset);
		int res = Fc3pxnNoBinWrap(l6act_bin, l6wght, l6ind, F6NPI, F6O, output, bn3mean, bn3var, bn3gamma, bn3beta);
		float max = -INFINITY; 
		int maxIdx = 0; 
		for (int i = 0; i <10; i++) { 
			 printf("%f, ", output[i]);
