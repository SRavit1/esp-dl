...
#define F1NPI  115
#define F1O  128
static pckDtype l1wght[] = _151 ;
static uint8_t l1ind[] = _151_indices ;
static pckDtype l1act_bin[F1I/pckWdt]; 
#define F2I  128
#define F2NPI  115
#define F2O  128
static pckDtype l2wght[] = _152 ;
static uint8_t l2ind[] = _152_indices ;
static pckDtype l2act_bin[F1O/pckWdt]; 
#define F3I  128
#define F3NPI  115
#define F3O  128
static pckDtype l3wght[] = _153 ;
static uint8_t l3ind[] = _153_indices ;
static pckDtype l3act_bin[F2O/pckWdt]; 
#define F4I  128
#define F4NPI  115
#define F4O  128
static pckDtype l4wght[] = _154 ;
static uint8_t l4ind[] = _154_indices ;
static pckDtype l4act_bin[F3O/pckWdt]; 
#define F5I  128
#define F5NPI  112
#define F5O  8
static pckDtype l5wght[] = _155 ;
static uint8_t l5ind[] = _155_indices ;
static pckDtype l5act_bin[F4O/pckWdt]; 
#define F6I  8
#define F6NPI  0
#define F6O  128
static pckDtype l6wght[] = _156 ;
static uint8_t l6ind[] = _156_indices ;
static pckDtype l6act_bin[F5O/pckWdt]; 
#define F7I  128
#define F7NPI  115
#define F7O  128
static pckDtype l7wght[] = _157 ;
static uint8_t l7ind[] = _157_indices ;
static pckDtype l7act_bin[F6O/pckWdt]; 
#define F8I  128
#define F8NPI  115
#define F8O  128
static pckDtype l8wght[] = _158 ;
static uint8_t l8ind[] = _158_indices ;
static pckDtype l8act_bin[F7O/pckWdt]; 
#define F9I  128
#define F9NPI  115
#define F9O  128
static pckDtype l9wght[] = _159 ;
static uint8_t l9ind[] = _159_indices ;
static pckDtype l9act_bin[F8O/pckWdt]; 
#define F10I  128
#define F10NPI  115
#define F10O  128
static pckDtype l10wght[] = _160 ;
static uint8_t l10ind[] = _160_indices ;
...
int main(){ 
	...
	for(int img = 0; img < 1; img++) {
		...
		Fc3pxnWrap(l1act_bin, l1wght, l1ind, F1NPI, F1O, l2act_bin, bn1thr, bn1sign, bn1offset, 1, 1);
		int64_t fc1_time = esp_timer_get_time();
		Fc3pxnWrap(l2act_bin, l2wght, l2ind, F2NPI, F2O, l3act_bin, bn2thr, bn2sign, bn2offset, 1, 1);
		int64_t fc2_time = esp_timer_get_time();
		Fc3pxnWrap(l3act_bin, l3wght, l3ind, F3NPI, F3O, l4act_bin, bn3thr, bn3sign, bn3offset, 1, 1);
		int64_t fc3_time = esp_timer_get_time();
		Fc3pxnWrap(l4act_bin, l4wght, l4ind, F4NPI, F4O, l5act_bin, bn4thr, bn4sign, bn4offset, 1, 1);
		int64_t fc4_time = esp_timer_get_time();
		Fc3pxnWrap(l5act_bin, l5wght, l5ind, F5NPI, F5O, l6act_bin, bn5thr, bn5sign, bn5offset, 1, 1);
		int64_t fc5_time = esp_timer_get_time();
		Fc3pxnWrap(l6act_bin, l6wght, l6ind, F6NPI, F6O, l7act_bin, bn6thr, bn6sign, bn6offset, 1, 1);
		int64_t fc6_time = esp_timer_get_time();
		Fc3pxnWrap(l7act_bin, l7wght, l7ind, F7NPI, F7O, l8act_bin, bn7thr, bn7sign, bn7offset, 1, 1);
		int64_t fc7_time = esp_timer_get_time();
		Fc3pxnWrap(l8act_bin, l8wght, l8ind, F8NPI, F8O, l9act_bin, bn8thr, bn8sign, bn8offset, 1, 1);
		int64_t fc8_time = esp_timer_get_time();
		Fc3pxnWrap(l9act_bin, l9wght, l9ind, F9NPI, F9O, l10act_bin, bn9thr, bn9sign, bn9offset, 1, 1);
		int64_t fc9_time = esp_timer_get_time();
		int res = Fc3pxnNoBinWrap(l10act_bin, l10wght, l10ind, F10NPI, F10O, output, bn10mean, bn10var, bn10gamma, bn10beta, 1, 1);
