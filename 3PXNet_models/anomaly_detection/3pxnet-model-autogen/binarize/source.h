...
int main(){ 
	...
	for(int img = 0; img < 1; img++) {
		...
		FcXnorWrap(l1act_bin, l1wght, F1I, F1O, l2act_bin, bn1thr, bn1sign, bn1offset, 1, 1);
		int64_t fc1_time = esp_timer_get_time();
		FcXnorWrap(l2act_bin, l2wght, F2I, F2O, l3act_bin, bn2thr, bn2sign, bn2offset, 1, 1);
		int64_t fc2_time = esp_timer_get_time();
		FcXnorWrap(l3act_bin, l3wght, F3I, F3O, l4act_bin, bn3thr, bn3sign, bn3offset, 1, 1);
		int64_t fc3_time = esp_timer_get_time();
		FcXnorWrap(l4act_bin, l4wght, F4I, F4O, l5act_bin, bn4thr, bn4sign, bn4offset, 1, 1);
		int64_t fc4_time = esp_timer_get_time();
		FcXnorWrap(l5act_bin, l5wght, F5I, F5O, l6act_bin, bn5thr, bn5sign, bn5offset, 1, 1);
		int64_t fc5_time = esp_timer_get_time();
		FcXnorWrap(l6act_bin, l6wght, F6I, F6O, l7act_bin, bn6thr, bn6sign, bn6offset, 1, 1);
		int64_t fc6_time = esp_timer_get_time();
		FcXnorWrap(l7act_bin, l7wght, F7I, F7O, l8act_bin, bn7thr, bn7sign, bn7offset, 1, 1);
		int64_t fc7_time = esp_timer_get_time();
		FcXnorWrap(l8act_bin, l8wght, F8I, F8O, l9act_bin, bn8thr, bn8sign, bn8offset, 1, 1);
		int64_t fc8_time = esp_timer_get_time();
		FcXnorWrap(l9act_bin, l9wght, F9I, F9O, l10act_bin, bn9thr, bn9sign, bn9offset, 1, 1);
		int64_t fc9_time = esp_timer_get_time();
		int res = FcXnorNoBinWrap(l10act_bin, l10wght, F10I, F10O, output, bn10mean, bn10var, bn10gamma, bn10beta, 1, 1);
